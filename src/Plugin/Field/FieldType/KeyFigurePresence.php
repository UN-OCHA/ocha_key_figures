...
/**
 * Plugin implementation of the 'key_figure_presence' field type.
 */
#[FieldType(
  id: 'key_figure_presence',
  label: new TranslatableMarkup('Key Figure (OCHA Presence)'),
  description: new TranslatableMarkup('A field to display key figures.'),
  category: 'unocha',
  default_widget: 'key_figure_presence',
  default_formatter: 'key_figure_presence',
)]
class KeyFigurePresence extends FieldItemBase {
  ...
  public static function propertyDefinitions(FieldStorageDefinitionInterface $field_definition) {
    ...
    $properties['ochapresence'] = DataDefinition::create('string')
      ->setLabel(new TranslatableMarkup('OCHA Office'))
      ->setDescription(new TranslatableMarkup('OCHA regional or country office.'))
      ->setRequired(FALSE);
  ...
  /**
   * Get the figure ochapresence.
   *
   * @return string|null
   *   Figure ochapresence.
   */
  public function getFigureOchaPresence() {
    return $this->get('ochapresence')->getValue() ?? NULL;
  }
  ...
  protected function getConfig() {
    if (!isset($this->config)) {
      $this->config = \Drupal::config('ocha_key_figures.settings');
    }
    return $this->config;
  }
